...
1/ For compiling and running the code under Linux, first install the Getfem++ library:
        1.1/ Download: http://download-mirror.savannah.gnu.org/releases/getfem/stable/getfem-5.4.2.tar.gz
        1.2/ Uncompress the file: "tar xvfz getfem-5.4.2.tar.gz"
        1.3/ Create the folder "learn_reg" in "./getfem-5.4.2/contrib/" 
        1.4/ Copy the "Makefile.am" in "./getfem-5.4.2/contrib/learn_reg/"
        1.5/ Modify the file Makefile.am located in ./getfem-5.4.2/contrib/ by adding the sub-folder "learn_reg"
        1.6/ Modify the file "./getfem-5.4.2/configure.ac" by adding around line 1200 the string 
                "contrib/learn_reg/Makefile                                      \"

2/ Install Getfem as follows: In "./getfem-5.4.2/"
...
4/  Compile the code:
        4.1/ First create a "MATLAB" folder in "./getfem-5.4.2/contrib/learn_reg/"
